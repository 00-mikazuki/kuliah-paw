                    ...
                    <table>
                            ...
                            <?php foreach ($categories as $category) : ?>
                                        <tr>
                                            ...
                                            <td><?=ucwords($category["namaKategori"])?></td>
                                            <td><a href="edit_kategori.php?kat=<?= $category["kodeKategori"]?>" class="primary-btn">Edit</a> 
                                            <a href="hapus_data_kategori.php?kat=<?= $category["kodeKategori"]?>" class="primary-btn">Hapus</a> <a href="produk_kategori.php?kat=<?= $category["kodeKategori"]?>" class="primary-btn">Lihat Produk</a> </td>
                                        </tr> 
                                <?php
                                    endforeach
                                ?>
